...
//*******************
//THIS CODE WAS NOT WRITTEN BY ME, WILLIAM, BUT IMPORTED AS PART OF A FREE PACKAGE
//*******************
...
{
	Water.GetComponent.<Renderer>().material.SetColor("_Tint", Color.Lerp (WaterNight, WaterDay, slider2*2-0.2));
}
